...
Original file is located at
    https://colab.research.google.com/drive/1cLbQPd16zGOwEcXmrCkyGQwZZHyDOA7V
"""
...
data = pd.read_csv('/content/drive/My Drive/Colab Notebooks/ML-Lab/1/mtcars.csv')
